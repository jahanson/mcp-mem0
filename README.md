...
```bash
docker pull jahanson/mcp-mem0:latest
```

The Docker images include SBOM (Software Bill of Materials) and SLSA provenance generated by GitHub Actions for enhanced security and supply chain transparency.
